...
population_2000,available_countries,excluded_countries_2000=hlp.extract_countries_feature_by_year(arab_df,arab_countries,'population',2000)
population_2010,available_countries,excluded_countries_2010=hlp.extract_countries_feature_by_year(arab_df,arab_countries,'population',2010)
...
def graph_8(arab_countries):
    ...
    world_by_record = hlp.extract_country_by_record(arab_df,'World','BiocapPerCap')
    traces.append(go.Scatter(
...
def graph_10(arab_countries):
    ...
    for c in range (0,len(arab_countries)):
        ...
        fig['layout'].update(height=450, width=1000,
                            title=str(arab_countries[c]))
    return [[trace1, trace2], fig['layout']]
