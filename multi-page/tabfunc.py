...
def tab4GraphsFunctionCall(graphlist, countrylist):
    if graphlist == 'GDP per Capita TrendCountry-wise Trend for EF vs BC':
        return dcc.Graph(id='display-map', 
                            figure={
                            "data": graphs.graph_10(countrylist)[0],
                            "layout": graphs.graph_10(countrylist)[1]
                        })
    elif graphlist == 'Entire UN Reion Ef vs BC Analysis':
        return dcc.Graph(id='display-map', 
