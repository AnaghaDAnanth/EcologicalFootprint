...
@app.callback(
    Output("card-content", "children", allow_duplicate=True), [Input("card-tabs", "active_tab")], prevent_initial_call=True,
)
...
@app.callback(
    Output("graph-op1", "children", allow_duplicate=True), Input("submit-button-state", "n_clicks"), State('country_checkbox', 'value'), State('chart_checkbox', 'value'), prevent_initial_call=True,
