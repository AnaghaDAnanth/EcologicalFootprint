...
arab_df = pd.read_csv("Europe.csv")
arab_countries = ['Yugoslav SFR','Lithuania','Slovenia','USSR','Netherlands','Malta','Norway','Croatia','Germany','Serbia and Montenegro','Ukraine','Albania','Moldova','Sweden','Montenegro','Estonia','Russian Federation''Switzerland','Serbia','Denmark','Latvia','United Kingdom','Finland','Bulgaria','Luxembourg','Poland','Greece','Bosnia and Herzegovina','Spain','Czechoslovakia','Romania','Belarus','Hungary','Belgium','Italy','Slovakia','France','Austria','Czech Republic','Ireland','Macedonia TFYR','Portugal']
