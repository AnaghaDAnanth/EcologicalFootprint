...
arab_df = pd.read_csv("America.csv")
arab_countries = ['Antigua and Barbuda', 'Argentina', 'Bahamas', 'Barbados','Bermuda', 'Bolivia', 'Brazil', 'Aruba', 'Belize', 'Canada','Cayman Islands', 'Chile', 'Colombia', 'Costa Rica', 'Cuba','Dominica', 'Dominican Republic', 'Ecuador', 'El Salvador','French Guiana', 'Grenada', 'Guadeloupe', 'Guatemala', 'Guyana','Haiti', 'Honduras', 'Jamaica', 'Martinique', 'Mexico','Montserrat', 'Nicaragua', 'Panama', 'Paraguay', 'Peru','Saint Lucia', 'Suriname', 'Trinidad and Tobago','United States of America', 'Uruguay','Venezuela, Bolivarian Republic of']

colors = ['blue','gray','red','green','blue', 'crimson', 'darkturquoise', 'steelblue','yellow','magenta','brown', 'peru','orange','tan','seagreen','olive', 'thistle','turquoise','mintcream','yellowgreen', "honeydew", "hotpink", "indianred", "indigo","ivory", "khaki", "lavender", "lavenderblush", "lawngreen","lemonchiffon", "lightblue", "lightcoral", "lightcyan","lightgoldenrodyellow", "lightgray", "lightgrey","lightgreen", "lightpink", "lightsalmon", "lightseagreen","lightskyblue", "lightslategray", "lightslategrey","lightsteelblue", "lightyellow", 'darkkhaki','coral','chocolate','rosybrown','dodgerblue','plum']
